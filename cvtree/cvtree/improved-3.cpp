...
//
//
//tuple<double,double> CompareBacteria_s2_s3(Bacteria* b1, Bacteria* b2)
//{
//    double vector_len1=0;
//    double vector_len2=0;
//    long p1 = 0;
...
//    while (p1 < b1->count || p2 < b2->count)
//    {
//        double t1 = (p1 < b1->count) ? b1->tv[p1] : 0;
//        double t2 = (p2 < b2->count) ? b2->tv[p2] : 0;
//
//        vector_len1 += (t1 * t1);
//        vector_len2 += (t2 * t2);
//
...
//    
//    printf("<%f, %f> \n",vector_len1,vector_len2);
//    return make_tuple(vector_len1, vector_len2);
//}
//
//// Doesn't work
...
////            double correlation = CompareBacteria_parallel_2(num_threads, b[i], b[j]);
//            
//            // Alternate CompareBacteria
////            CompareBacteria_s2_s3(b[i], b[j]);
//            
